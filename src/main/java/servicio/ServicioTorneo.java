...
public class ServicioTorneo {
    ...
    public ResponseEntity<Void> generarCalendarioGrupos(@PathVariable int id) {
        try {
            ...
            // 3. Generamos partidos para cada grupo (Todos contra todos)
