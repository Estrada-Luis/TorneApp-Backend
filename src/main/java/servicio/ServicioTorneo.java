...
public class ServicioTorneo {
    ...
    public ResponseEntity<Torneo> crearTorneoConArchivo(
        ...
        try {
            if (archivo != null && !archivo.isEmpty()) {
                ...
                // Guardamos el nombre en el campo de la entidad
    ...
    // --- PARA EL MÓVIL: DESCARGAR/VER PDF ---
    ...
    /**
     * ✅ MÉTODO AÑADIDO: Para que GestionTorneo no de error
     * Llama al conteo que hace el DAO sobre la tabla inscripciones
     */
