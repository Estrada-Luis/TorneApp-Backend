...
public class ServicioTorneo {
    ...
    public List<FilaClasificacion> obtenerClasificacion(@PathVariable int idTorneo) {
        ...
        // Calcular estadísticas recorriendo los resultados de los partidos de este torneo
        for (Juega j : todosLosResultados) {
            if (j.getPartido().getTorneo().getIdTorneo() == idTorneo) {
                ...
                if (fila != null) {
                    ...
                    // Contamos como partido jugado si tiene resultado asignado (String != null o vacío)
        ...
        // Devolver lista ordenada por puntos (y luego por goles si empatan)
    ...
    // --- MÉTODOS PARA EL HISTORIAL (MÓVIL) ---
    ...
    // Esta clase es la que Android recibirá como JSON para la tabla
